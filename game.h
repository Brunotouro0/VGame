...
#define SHIP_PATROL_WIDTH 2

//Constantes do Auto-Scroll e Velocidade
...
//Game States
typedef enum { //enum eles sao uma coletanea de constantes (amigos veteranos falaram que era bom fazer isso)
    STATE_MENU,
    STATE_PLAYING,
    STATE_PAUSED,
    STATE_GAME_OVER,
